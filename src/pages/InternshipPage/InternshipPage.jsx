/* eslint-disable react/no-unescaped-entities */ /* eslint-disable no-unused-vars */   
         ...
         <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center">
           ...
           <div className="lg:w-1/2 relative">
             <div className="relative z-10">
               <Target className="w-96 h-96 text-[#6764C9]/30 mx-auto" />
           ...
           <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
             ...
             >
               <div className="flex items-center mb-4">
                 ...
                 <div>
                   <h4 className="font-bold">Sanskrati Agrawal</h4>
                   <p className="text-sm text-white/70">UI/UX Role at KodeVortex</p>
                 </div>
               </div>
               <p className="text-white/80 italic">
                 "My internship was a game-changer. The guidance I received and the practical projects I worked on equipped me with the expertise I needed to secure my dream role."
               </p>
             </motion.div>
             ...
             >
               <div className="flex items-center mb-4">
                 ...
                 <div>
                   <h4 className="font-bold">Sonal Mittal</h4>
                   <p className="text-sm text-white/70">FullStack Developer at KodeVortex</p>
                 </div>
               </div>
               <p className="text-white/80 italic">
                 "My internship experience was transformative. The mentorship and hands-on projects helped me build skills that landed me my dream job."
               </p>
             </motion.div>
             ...
             >
               <div className="flex items-center mb-4">
                 ...
                 <div>
                   <h4 className="font-bold">Harsh Verma</h4>
                   <p className="text-sm text-white/70">FullStack Developer at KodeVortex</p>
                 </div>
               </div>
               <p className="text-white/80 italic">
                 "During my internship, the exceptional mentorship and immersive project work significantly boosted my abilities, ultimately paving the way for me to achieve my career aspirations."
               </p>
             </motion.div>
           </div>
         </div>
