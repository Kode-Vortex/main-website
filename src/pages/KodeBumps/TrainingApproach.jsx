    ...
    const handleScroll = () => {
      if (sectionRef.current) {
        ...
        // When element is fully in viewport
          ...
          percentage = Math.min(
            1,
            Math.abs(elementTop) / (elementHeight - windowHeight)
          );
        }
  ...
  const phases = [
    {
      title: "Phase 1",
      description:
        "A 6-day intensive hands-on training program covering 42 hours of practical learning. Designed for in-depth skill development, it includes interactive sessions, real-world applications, and expert guidance.",
      icon: "🎓",
    },
    {
      title: "Phase 2",
      description:
        "A comprehensive program focused on project development and mentoring, specifically for hackathons. It provides expert guidance, hands-on experience, and strategic support to enhance innovation and problem-solving skills.",
      icon: "💻",
    },
    {
      title: "Phase 3",
      description:
        "A dynamic program offering startup incubation and industry exposure. It provides mentorship, networking opportunities, and practical insights to help innovators transform ideas into successful ventures.",
      icon: "🚀",
    },
    {
      title: "Phase 4",
      description:
        "A structured program offering continuous online guidance and expert mentoring. It ensures personalized support, skill enhancement, and career growth through interactive sessions with industry professionals.",
      icon: "🔄",
    },
  ];
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden opacity-10">
        ...
        <motion.div
          ...
          style={{
            borderColor:
              getInterpolatedColor(startColor, endColor, scrollPercentage) +
              "4D", // 30% opacity
          }}
        />
        ...
        <motion.div
          ...
          style={{
            borderColor:
              getInterpolatedColor(endColor, startColor, scrollPercentage) +
              "33", // 20% opacity
          }}
        />
        ...
        >
          <motion.div className="flex flex-col items-center justify-center space-y-6">
            <motion.h2
              ...
              style={{
                backgroundImage: `linear-gradient(to right, ${startColor}, ${getInterpolatedColor(
                  startColor,
                  endColor,
                  0.5
                )})`,
        ...
        >
          ...
          >
            ...
            {Array.from({ length: lineSegments }).map((_, i) => {
              ...
              const nextSegmentColor = getSegmentColor(
                Math.min(i + 1, lineSegments - 1),
                lineSegments
              );
                ...
                >
                  ...
                  <div
                    className={`absolute top-1/2 -mt-2 w-4 h-4 bg-[#2c2c2c] border-t border-r ${
                      index % 2 === 0
                        ? "right-[-8px] border-gray-800 rotate-45"
                        : "left-[-8px] border-gray-800 rotate-[225deg]"
                    } hidden md:block`}
                  ></div>
